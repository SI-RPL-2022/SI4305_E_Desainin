...
@section('right')
    <div class="container px-5 py-5">
        ...
        <form style="padding-bottom: 30px">
            <div class="mb-3">
                <input type="text" class="form-control" id="regloginfont" placeholder="Full Name">
            </div>
            <div class="mb-3">
                <input type="email" class="form-control" id="regloginfont" placeholder="Email">
            </div>
            <div class="mb-3">
                <input type="tel" class="form-control" id="regloginfont" placeholder="Phone Number">
            </div>
            <div class="mb-3">
                <input type="password" class="form-control" id="regloginfont" placeholder="Password">
            </div>
