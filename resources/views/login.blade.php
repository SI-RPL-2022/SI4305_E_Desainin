...
@section('right')
    <div class="container">
        <div class="container px-5 py-5">
            ...
            <form>
                <div class="mb-3">
                    <input type="text" class="form-control" id="regloginfont" placeholder="Email or Phone Number">
                </div>
                <div class="mb-3">
                    <input type="password" class="form-control" id="regloginfont" placeholder="Password">
                </div>
                <div class="mb-3 form-check pb-2" align="right">
                    <a id="regloginfont" class="form-check-label" href="/forgotpassword">Forgot Password?</a>
                </div>
